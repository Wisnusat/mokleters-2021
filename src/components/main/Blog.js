                    ...
                    <div class="card-body">
                      <p class="card-text mb-2">
                        <a className="text-decoration-none text-white" href="#">
                          <small class="text-red">IT</small>
                        </a>
                      </p>

                      <a className="text-decoration-none text-white" href="#">
                        <h5 class="card-title">
                          The Best 3 Social Media Analytics Tools For Competitor
                          Analysis
                        </h5>
                      </a>
                      <p class="card-text border-top pt-2">
                        <small class="text-secondary">18 November 2021</small>
                      </p>
                    </div>
                  </div>
                </div>
                <div className="hover col nopadding">
                  <div class="card bg-dark-cs border-0">
                    ...
                    <div class="card-body">
                      <p class="card-text mb-2">
                        <a className="text-decoration-none text-white" href="#">
                          <small class="text-red">Social</small>
                        </a>
                      </p>
                ...
                <div className="hover col nopadding">
                  <div class="card bg-dark-cs border-0">
                    ...
                    <div class="card-body">
                      <p class="card-text mb-2">
                        <a className="text-decoration-none text-white" href="#">
                          <small class="text-red">Education</small>
                        </a>
                      </p>
